# Contributing to FlockML Enterprise

Thank you for your interest in contributing to the public FlockML Enterprise architecture and reference specifications.

## Code of Conduct & Governing Principle

Our governing principle is **PROVE, DON'T PROMISE.**
- All claims regarding performance, compliance, or architecture must be factual, verifiable, and free of marketing hyperbole.
- Distinguish explicitly between **Implemented**, **Validated Automatically**, **Physically Validated**, **Proposed**, **Experimental**, and **Future**.
- Never fabricate benchmarks, customer approvals, or regulatory certifications.
